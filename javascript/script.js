...
function updateTimer() {
  const targetDate = new Date("january 17, 2025 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543814025613'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543814025613'; // Número para el primer botón
  const recipientNumber2 = '543816852352'; // Número para el segundo botón
